...
const _credentialsTypeChoices = {
  storefront: [
    { value: "password", label: "Use my email/password that I use to sign in on the storefront" },
    { value: "bearerToken", label: "I already have the bearer token, so just use it directly" },
  ],
  admin: [
    { value: "password", label: "Use my username/password that I have to access the admin panel" },
    { value: "applicationKey", label: "Use the application key that was generated on the admin panel" },
    { value: "bearerToken", label: "I already have the bearer token, so just use it directly" },
  ],
};
